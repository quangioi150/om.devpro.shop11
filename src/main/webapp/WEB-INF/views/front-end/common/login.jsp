                    ...
                    <div class="col-xl-8 nav">
                        <ul>
                           ...
                           <li><a href="${pageContext.request.contextPath}/about-us">GIỚI THIỆU</a></li>
                            ...
                            <li><a href="${pageContext.request.contextPath}/cart"><i class="fas fa-cart-plus"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                  ...
                  <form action="${pageContext.request.contextPath}/Customer-page" method="post">
                        ...
                        <button type="submit">Đăng nhập</button>&emsp;&emsp;
                        <span><a href="${pageContext.request.contextPath}/register">Đăng ký</a></span>
                        </div>
                    </form>
                </div>
            </div>
