                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="${pageContext.request.contextPath}/layouts-horizontal">Horizontal</a></li>
                                    <li><a href="${pageContext.request.contextPath}/layouts-light-sidebar">Light Sidebar</a></li>
                                    <li><a href="${pageContext.request.contextPath}/layouts-compact-sidebar">Compact Sidebar</a></li>
                                    <li><a href="${pageContext.request.contextPath}/layouts-icon-sidebar">Icon Sidebar</a></li>
                                    <li><a href="${pageContext.request.contextPath}/layouts-boxed">Boxed Width</a></li>
                                    <li><a href="${pageContext.request.contextPath}/layouts-preloader">Preloader</a></li>
                                    <li><a href="${pageContext.request.contextPath}/layouts-colored-sidebar">Colored Sidebar</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="${pageContext.request.contextPath}/add-products">Products</a></li>
                                    ...
                                    <li><a href="${pageContext.request.contextPath}/add-products">Add Product</a></li>
                                </ul>
                            </li>
