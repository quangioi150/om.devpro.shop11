...
import com.devpro.model.CheckoutAddress;
...
public class CheckoutAddressController {
	...
	public String index(final ModelMap model, final HttpServletRequest request, final HttpServletResponse response)
			throws Exception {
		model.addAttribute("CheckoutAddress", new CheckoutAddress());
		return "back-end/checkout-address";
	}
	...
	public String index1(final ModelMap model, final HttpServletRequest request, final HttpServletResponse response)
			throws Exception {
		model.addAttribute("CheckoutAddress", new CheckoutAddress());
		return "back-end/checkout-thankyou";
	}
}
